...
const RestrictionsTable = () => {
  ...
  return (
    <div className="space-y-4">
      {/* Filters */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-4 p-4 bg-gray-50 rounded-lg">
        <div>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">RML</label>
          <Select>
            <SelectTrigger className="focus:ring-[#FF732D] focus:border-[#FF732D]">
        ...
        <div className="col-span-full md:col-span-2 lg:col-span-4 xl:col-span-3 flex items-end">
        ...
        <Table>
          <TableHeader className="bg-[#FF732D]">
            <TableRow>
              ...
              <TableHead className="text-white">RML</TableHead>
              <FilterHeader 
                title="Group Type" 
                sortable 
